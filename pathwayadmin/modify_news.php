...
<BODY onload="chkRemLength(document.modify_news.news_article_desc,document.getElementById('remChars'),350);">
		  ...
		  <td align="center" valign="top" background="/images/header/inner_main_bg.gif" style="background-repeat:repeat-y; padding-left:20px">
          		<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td width="75%" align="left" valign="top" style="padding-top:3">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        <td align="left" valign="top"><?php require_once('./middle/modify_news_middle.php'); ?></td>
                        </tr>
                        </table>
                    </td>
                    </tr>
